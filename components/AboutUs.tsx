...
export const AboutUs: React.FC<AboutUsProps> = ({ language, translations: t }) => {
  ...
  return (
    <div className="space-y-20 animate-in fade-in slide-in-from-bottom-10 duration-1000 pb-32" dir={isRTL ? 'rtl' : 'ltr'}>
      {/* HERO SECTION */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl mx-auto px-6">
        <div className="bg-white/10 backdrop-blur-3xl p-12 rounded-[4rem] border border-white/20 shadow-2xl hover:scale-[1.02] transition-transform duration-700">
          <div className="w-16 h-16 bg-indigo-600 rounded-3xl flex items-center justify-center text-3xl shadow-xl mb-8">🎯</div>
          <h2 className="text-4xl font-black text-white italic tracking-tight mb-6">{t.missionTitle}</h2>
          <p className="text-lg text-white/60 font-medium leading-relaxed">
            {t.missionText}
          </p>
          <div className="mt-8 pt-8 border-t border-white/5 flex items-center gap-4">
             <div className="w-1.5 h-1.5 rounded-full bg-indigo-400"></div>
             <p className="text-[9px] font-black text-indigo-300 uppercase tracking-widest">Excellence • Algérie • Innovation</p>
          </div>
        </div>
        ...
        <div className="bg-indigo-950/50 backdrop-blur-3xl p-12 rounded-[4rem] border border-white/10 shadow-2xl hover:scale-[1.02] transition-transform duration-700">
          <div className="w-16 h-16 bg-violet-600 rounded-3xl flex items-center justify-center text-3xl shadow-xl mb-8">👁️</div>
          <h2 className="text-4xl font-black text-white italic tracking-tight mb-6">{t.visionTitle}</h2>
          <p className="text-lg text-white/60 font-medium leading-relaxed">
            {t.visionText}
          </p>
          <div className="mt-8 pt-8 border-t border-white/5 flex items-center gap-4">
             <div className="w-1.5 h-1.5 rounded-full bg-violet-400"></div>
             <p className="text-[9px] font-black text-violet-300 uppercase tracking-widest">Confiance • Prestige • Futur</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 text-center space-y-10">
        <h3 className="text-[11px] font-black text-indigo-400 uppercase tracking-[0.4em]">Le Manifeste LOCADZ</h3>
        <p className="text-3xl md:text-5xl font-black text-white italic tracking-tighter leading-tight">
          "Nous ne louons pas des murs, nous créons des <span className="animate-shine-text">portails vers l'exceptionnel</span>."
        </p>
        <div className="flex justify-center items-center gap-8 pt-10">
           <div className="text-center">
              <p className="text-4xl font-black text-white">48</p>
              <p className="text-[9px] font-black text-white/40 uppercase tracking-widest">Wilayas</p>
           </div>
           <div className="w-[1px] h-12 bg-white/10"></div>
           <div className="text-center">
              <p className="text-4xl font-black text-white">100%</p>
              <p className="text-[9px] font-black text-white/40 uppercase tracking-widest">Sécurité AI</p>
           </div>
           <div className="w-[1px] h-12 bg-white/10"></div>
           <div className="text-center">
              <p className="text-4xl font-black text-white">24/7</p>
              <p className="text-[9px] font-black text-white/40 uppercase tracking-widest">Support Concierge</p>
           </div>
        </div>
      </div>
    </div>
